...
import com.example.myapplication.adapters.PatientWaitingAdapter
...
class PatientWaitingFormActivity : AppCompatActivity() {
    ...
    private fun fetchQueueData() {
        ...
        apiService.getQueue().enqueue(object : Callback<com.example.myapplication.models.PatientQueueResponse> {
            override fun onResponse(
                call: Call<com.example.myapplication.models.PatientQueueResponse>,
                response: Response<com.example.myapplication.models.PatientQueueResponse>
            ) {
            ...
            override fun onFailure(call: Call<com.example.myapplication.models.PatientQueueResponse>, t: Throwable) {
                progressDialog.dismiss()
                swipeRefreshLayout.isRefreshing = false
                Toast.makeText(
                    this@PatientWaitingFormActivity,
